...
public class SawScreen extends ContainerScreen<SawContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Main.modId,
            "textures/gui/saw_gui.png");

    public SawScreen(SawContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
