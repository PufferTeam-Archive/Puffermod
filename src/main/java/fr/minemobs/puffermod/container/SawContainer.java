package fr.minemobs.puffermod.container;
...
import fr.minemobs.puffermod.utils.FunctionalIntReferenceHolder;
...
public class SawContainer extends Container {
    ...
    private SawTileEntity tileEntity;
    private IWorldPosCallable canInteractWithCallable;
    public FunctionalIntReferenceHolder currentSmeltTime;

    //SERVER CONSTRUCTOR
    public SawContainer(final int windowID, final PlayerInventory playerInv, final SawTileEntity tile) {
    ...
    //CLIENT CONSTRUCTOR
    public SawContainer(final int windowID, final PlayerInventory playerInv, final PacketBuffer data) {
        this(windowID, playerInv, getTileEntity(playerInv, data));
    }

    private static SawTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
        Objects.requireNonNull(playerInv, "playerInv cannot be null");
        Objects.requireNonNull(data, "data cannot be null");
        final TileEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof SawTileEntity) {
            return (SawTileEntity) tileAtPos;
        }
