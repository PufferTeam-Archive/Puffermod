...
import fr.minemobs.puffermod.init.RecipeSerializerInit;
...
public class SawTileEntity extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    public SawTileEntity(TileEntityType<?> tileEntityTypeIn) {
    ...
    public SawTileEntity() {
        this(ModTileEntityTypes.SAW.get());
    }

    @Override
    public Container createMenu(final int windowID, final PlayerInventory playerInv, final PlayerEntity playerIn) {
        return new SawContainer(windowID, playerInv, this);
    }
                ...
                if (this.getRecipe(this.inventory.getStackInSlot(0)) != null) {
                    if (this.currentSmeltTime != this.maxSmeltTime) {
                        this.world.setBlockState(this.getPos(),
                                this.getBlockState().with(SawBlock.LIT, true));
                        this.currentSmeltTime++;
                        dirty = true;
                    } else {
                        this.world.setBlockState(this.getPos(),
                                this.getBlockState().with(SawBlock.LIT, false));
    ...
    private ITextComponent getDefaultName() {
        return new TranslationTextComponent("container." + Main.modId + ".saw_block");
    }
